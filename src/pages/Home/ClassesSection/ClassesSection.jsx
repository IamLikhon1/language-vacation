...
const ClassesSection = () => {
    return (
        <div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mx-10 my-20">
           ...
           <div className="card card-compact w-full hover:bg-purple-300 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className="font-medium">Number Of Students: 355</p>
           ...
           <div className="card card-compact w-full hover:bg-orange-300 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className="font-medium">Number Of Students: 255</p>
           ...
           <div className="card card-compact w-full hover:bg-purple-300 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className="font-medium">Number Of Students: 425</p>
           ...
           <div className="card card-compact w-full hover:bg-orange-300 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className="font-medium">Number Of Students: 159</p>
           ...
           <div className="card card-compact w-full  hover:bg-purple-300 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className="font-medium">Number Of Students: 320</p>
