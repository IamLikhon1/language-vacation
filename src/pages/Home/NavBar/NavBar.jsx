...
const NavBar = () => {
 ...
 .then(()=>{})
  ...
  <div className="navbar-start">
   ...
   <Link to='/'> <span className="btn btn-ghost normal-case text-xl font-serif items-center text-white">Foreign <span className="text-orange-500">Language</span></span></Link>
  </div>
